...
python data_process/phenotype_refactor.py \
    --ped-file "D:\03.projects\AI.PGT\data\SNP_results\PGT_TLS_ALL\PLINK_291025_0948\PGT_TLS_ALL.ped" \
    --phenotype-file "D:\03.projects\AI.PGT\data\SNP_results\PGT_TLS_ALL\PLINK_291025_0948\PGT_TLS_ALL.phenotype" \
    --full-phenotype-file "D:\03.projects\AI.PGT\snparray_analysis\work_dir\clinical_snparray_phenotype.csv" \
    --output-ped "D:\03.projects\AI.PGT\data\SNP_results\PGT_TLS_ALL\PLINK_291025_0948\PGT_TLS_ALL.refactor.ped" \
    --output-phenotype "D:\03.projects\AI.PGT\data\SNP_results\PGT_TLS_ALL\PLINK_291025_0948\PGT_TLS_ALL.refactor.phenotype" \
