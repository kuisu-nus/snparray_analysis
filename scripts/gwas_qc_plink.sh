...
plink --bfile ${INPUT}_step4 --remove sex_discrepancy.txt --make-bed --out ${INPUT}_step5
...
plink --bfile ${INPUT}_step5 --extract snp_1_22.txt --make-bed --out ${INPUT}_step6

plink --bfile ${INPUT}_step6 --freq --out MAF_check
# Rscript --no-save MAF_check.R

plink --bfile ${INPUT}_step6 --maf $MAF --make-bed --out ${INPUT}_step7

# Step 4: Hardy-Weinberg equilibrium
echo "Step 4/6: Hardy-Weinberg equilibrium"
plink --bfile ${INPUT}_step7 --hardy
awk '{ if ($9 <0.00001) print $0 }' plink.hwe > plinkzoomhwe.hwe
# Rscript --no-save hwe.R

plink --bfile ${INPUT}_step7 --hwe 1e-6 --make-bed --out ${INPUT}_hwe_temp
plink --bfile ${INPUT}_hwe_temp --hwe 1e-10 --hwe-all --make-bed --out ${INPUT}_step8
...
plink --bfile ${INPUT}_step8 --remove het_fail_ind.txt --make-bed --out ${INPUT}_step9
